var X00Gems = ['20.000 pulsa', '50.000 pulsa', '100.000 pulsa','10.000 pulsa','5.000 pulsa','200.000 pulsa','25.000 pulsa'];
var X00Processes = [
  { X00Percent: 2, X00Text: 'Menyambung ke server...' },
  { X00Percent: 4, X00Text: 'Memvalidasi User...' },
  ...
  { X00Percent: 12, X00Text: 'Connecting to server...' },
  ...
  { X00Percent: 74, X00Text: 'Generating Resources..' },
  { X00Percent: 74, X00Text: 'Generating Resources...' },
  { X00Percent: 77, X00Text: 'Injecting Pulsa.' },
  { X00Percent: 77, X00Text: 'Injecting Pulsa..' },
  { X00Percent: 77, X00Text: 'Injecting Pulsa....' },
  { X00Percent: 77, X00Text: 'Injecting Pulsa.....' },
  { X00Percent: 77, X00Text: 'Injecting Pulsa......' },
  { X00Percent: 77, X00Text: 'Injecting Superscript.' },
  { X00Percent: 77, X00Text: 'Injecting Superscript..' },
  { X00Percent: 77, X00Text: 'Injecting Superscript...' },
  { X00Percent: 77, X00Text: 'Injecting Superscript....' },
  { X00Percent: 77, X00Text: 'Injecting Superscript.....' },
  { X00Percent: 77, X00Text: 'Unlocking key xbUuCB.' },
  { X00Percent: 77, X00Text: 'Unlocking key ju2juujU..' },
  { X00Percent: 77, X00Text: 'Unlocking key UbgsYT8h...' },
  { X00Percent: 77, X00Text: 'Unlocking key kLOhhT5as....' },
  { X00Percent: 77, X00Text: 'Unlocking key Ugh19G1jr2.....' },
  ...
  { X00Percent: 98, X00Text: 'Verification...' },
  { X00Percent: 98, X00Text: 'Verification.....' },
  { X00Percent: 100, X00Text: 'Selesai.' },
];
var X00ProcessCurrent = 0;
/* var X00ProcessDelay = 5000; */
...
function X00ActivitiesAdd() {
  ...
  $('<div style="text-align: center;"><span class="label label-primary" style="font-weight: bold;"> 08' + X00Random(5,7,9) + '' + X00Random(100, 255) + '' + X00Random(100, 255) + 'xxx</span> <span class="label label-default" style="font-weight: bold;">telah mendapatkan</span> <span class="label label-success" style="font-weight: bold;">' + X00Gems[X00Random(0, X00Gems.length)] + ' </span> <span id="X00ActivitySeconds" class="label label-info" style="font-weight: bold;">0s ago</span></div>').appendTo('#X00Activities').hide().fadeIn(250);
  X00ActivityIntervalSeconds = setInterval(function() {
    X00ActivitySecondsCurrent++;
    $('#X00ActivitySeconds').html(X00ActivitySecondsCurrent + 'detik lalu');
  }, 1000);
}
...
$(function() {
  ...
  $('#X00ButtonStart').click(function() {
    if ($('#X00InputUsername').val() == '') {$('#X00InputUsername').focus();}
	  ...
	  $('#X01Gems').html($('#X01InputGems').val());
	  $('#X02Gems').html($('#X02InputGems').val());
	  $('#X03Gems').html($('#X03InputGems').val());
